...
date: 2026-03-05
featured: true
thumbnail: assets/img/2026-03-05-flash4/fa4_fwd_causalTrue_hdim128.png
...
toc:
  - name: New hardware features on Blackwell
  - name: Feeds and Speeds
  - name: "Forward pass: New softmax pipelining with conditional rescaling"
    subsections:
      - name: "Pipeline: Ping-pong Q tiles plus a dedicated correction stage"
      - name: "Faster exponential: Distribute 2^x across MUFU.EX2 and FMA"
  - name: "Backward pass: Where shared memory traffic dominates"
    subsections:
      - name: "Pipeline: Overlap MMAs with softmax"
      - name: "2-CTA backward pass: Reducing shared memory traffic and global atomic adds"
      - name: "Deterministic mode"
  - name: Scheduling
  - name: "Language and framework: CuTe-DSL"
  - name: Attention Benchmarks
  - name: Acknowledgements

---

[[Paper](https://github.com/Dao-AILab/flash-attention/blob/main/assets/fa4_paper.pdf)]
[[Code](https://github.com/Dao-AILab/flash-attention)]

{% include figure.liquid loading="eager" path="assets/img/2026-03-05-flash4/h100_vs_b200.png" %}
...
In this blog post, we present FlashAttention-4, an algorithm and kernel co-design that maximizes overlap between matmul and these other resource bottlenecks. On B200 with BF16, it reaches up to 1605 TFLOPs/s (71% utilization), up to 1.3x faster than cuDNN version 9.13 and 2.7x faster than Triton.
...
{% include figure.liquid loading="eager" path="assets/img/2026-03-05-flash4/2cta_mma.png" %}
...
{% include figure.liquid loading="eager" path="assets/img/2026-03-05-flash4/fa4_fwd_pipeline.png" %}
...
{% include figure.liquid loading="eager" path="assets/img/2026-03-05-flash4/fa4_bwd_pipeline.png" %}
...
{% include figure.liquid loading="eager" path="assets/img/2026-03-05-flash4/2cta_bwd_tiles.png" %}
...
{% include figure.liquid loading="eager" path="assets/img/2026-03-05-flash4/2cta_dq_dsmem.png" %}
...
{% include figure.liquid loading="eager" path="assets/img/2026-03-05-flash4/fa4_fwd_causalFalse_hdim128.png" %}
{% include figure.liquid loading="eager" path="assets/img/2026-03-05-flash4/fa4_fwd_causalTrue_hdim128.png" %}
{% include figure.liquid loading="eager" path="assets/img/2026-03-05-flash4/fa4_bwd_causalFalse_hdim128.png" %}
{% include figure.liquid loading="eager" path="assets/img/2026-03-05-flash4/fa4_bwd_causalTrue_hdim128.png" %}
